function load(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        var c12 = document.createTextNode(data[i].c12);
        var c13 = document.createTextNode(data[i].c13);
        var c14 = document.createTextNode(data[i].c14);
        var c15 = document.createTextNode(data[i].c15);
        var c16 = document.createTextNode(data[i].c16);
        ...
        td12.className = "col12";
        td12.appendChild(c12);
        var td13 = document.createElement("td");
        td13.className = "col13";
        td13.appendChild(c13);
        var td14 = document.createElement("td");
        td14.className = "col14";
        td14.appendChild(c14);
        var td15 = document.createElement("td");
        td15.className = "col15";
        td15.appendChild(c15);
        var td16 = document.createElement("td");
        td16.className = "col16";
        td16.appendChild(c16);
